...
public class JPAConfig {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
		...
		emf.setPackagesToScan("com.koushik.movieflix.entities");
	...
	private Properties jpaProperties() {
		...
		props.setProperty(PersistenceUnitProperties.DDL_GENERATION, PersistenceUnitProperties.NONE);//CREATE_OR_EXTEND);//
